                ...
                <div class="summary">
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="summary-category"></span>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            <h4>Adres odbioru:</h4>
                            <ul>
                                <li><span id="summary-street"></span></li>
                                <li><span id="summary-city"></span></li>
                                <li><span id="summary-zipCode"></span></li>
                                <li><span id="summary-phone"></span></li>
                            </ul>
                        </div>
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li><span id="summary-pickUpDate"></span></li>
                                <li><span id="summary-pickUpTime"></span></li>
                                <li><span id="summary-pickUpComment"></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
